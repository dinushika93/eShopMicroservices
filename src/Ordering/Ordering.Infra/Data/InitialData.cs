...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "DinushiKa", "dinu@gmail.com"),
    ...
    public static IList<Order> Orders
    {
        get
        {
            var address1 = Address.Of("dinushika", "hewage", "dinu@gmail.com", "Verve suite", "Mont Kiara", "Kuala Lumpur", "50480");
